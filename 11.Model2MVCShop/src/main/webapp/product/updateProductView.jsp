...
<body>
	...
	<div class="container">
		...
		<h1 class="bg-primary text-center">상품 정보수정</h1>		
		...
		<input type="hidden" name="menu" id="menu" value="${ param.menu }"/>
		  ...
		  <div class="form-group">
		    <label for="manuDate" class="col-sm-offset-1 col-sm-3 control-label">상품 등록일자</label>
		    <div class="col-sm-4">
		  ...
		  <div class="form-group">
		    <label for="ssn" class="col-sm-offset-1 col-sm-3 control-label">상품 이미지</label>
		    <div class="col-sm-4">
